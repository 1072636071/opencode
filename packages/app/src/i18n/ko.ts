export const dict = {
  ...
  "command.session.export.description": "세션 전체 대화 내용을 JSON으로 내보내기",
  ...
  "prompt.slash.hiddenSkillsHint": "스킬 명령 {{count}}개 숨김",
  ...
  "time.yesterday": "어제",
  "session.review.collapse": "접기",
  "session.review.collapse.ariaLabel": "리뷰 패널 접기",
