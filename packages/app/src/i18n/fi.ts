export const dict = {
  ...
  "command.session.export.description": "Vie koko istunnon transkriptio JSON-muodossa",
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} taitokomentoa piilotettu",
  ...
  "session.review.collapse": "Supista",
  "session.review.collapse.ariaLabel": "Supista tarkastuspaneeli",
