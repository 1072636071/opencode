export const dict = {
  ...
  "command.session.export.description": "ਸੈਸ਼ਨ ਦੀ ਪੂਰੀ ਟ੍ਰਾਂਸਕ੍ਰਿਪਟ ਨੂੰ JSON ਵਜੋਂ ਨਿਰਯਾਤ ਕਰੋ",
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} ਸਕਿੱਲ ਕਮਾਂਡ ਲੁਕਾਈਆਂ ਗਈਆਂ",
  ...
  "toast.session.export.success.title": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਹੋ ਗਿਆ",
  "toast.session.export.success.description": "ਸੈਸ਼ਨ {{filename}} ਵਿੱਚ ਸੇਵ ਕੀਤਾ ਗਿਆ",
  "toast.session.export.failed.title": "ਸੈਸ਼ਨ ਨਿਰਯਾਤ ਕਰਨ ਵਿੱਚ ਅਸਫਲ",
  ...
  "time.yesterday": "ਕਲ",
  "session.review.collapse": "ਸਮੇਟੋ",
  "session.review.collapse.ariaLabel": "ਸਮੀਖਿਆ ਪੈਨਲ ਸਮੇਟੋ",
