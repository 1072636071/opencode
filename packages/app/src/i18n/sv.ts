export const dict = {
  ...
  "command.session.export.description": "Exportera hela sessionstranskriptet som JSON",
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} färdighetskommandon dolda",
  ...
  "toast.session.export.success.description": "Session sparad i {{filename}}",
  "toast.session.export.failed.title": "Det gick inte att exportera sessionen",
  "toast.session.export.failed.description": "Ett fel uppstod vid export av sessionen",
  ...
  "time.yesterday": "Igår",
  "session.review.collapse": "Dölj",
  "session.review.collapse.ariaLabel": "Dölj granskningspanel",
