export const dict = {
  ...
  "command.session.export.description": "Exporteer het volledige sessietranscript als JSON",
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} skill-opdrachten verborgen",
  ...
  "toast.session.export.failed.title": "Exporteren van sessie mislukt",
  ...
  "session.review.collapse": "Inklappen",
  "session.review.collapse.ariaLabel": "Review-paneel inklappen",
  ...
  "settings.agents.toast.saved.title": "Modelbinding opgeslagen voor {name}",
