export const dict = {
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} urzh skiant kuzhet",
  ...
  "session.review.collapse": "Recolher",
  "session.review.collapse.ariaLabel": "Recolher painel de revisão",
  ...
  "settings.agents.toast.saved.title": "Vínculo de modelo salvo para {name}",
