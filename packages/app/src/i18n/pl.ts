export const dict = {
  ...
  "prompt.slash.hiddenSkillsHint": "Ukryto {{count}} poleceń umiejętności",
  ...
  "toast.session.export.success.description": "Sesja zapisana do {{filename}}",
  ...
  "session.review.collapse": "Zwiń",
  "session.review.collapse.ariaLabel": "Zwiń panel recenzji",
  ...
  "settings.agents.model.placeholder": "Automatycznie",
  "settings.agents.toast.saved.title": "Zapisano powiązanie modelu dla {name}",
