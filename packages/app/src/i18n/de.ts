...
export const dict = {
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} Skill-Befehle ausgeblendet",
  ...
  "session.review.collapse": "Einklappen",
  "session.review.collapse.ariaLabel": "Review-Panel einklappen",
  ...
  "settings.skills.title": "Fähigkeiten",
