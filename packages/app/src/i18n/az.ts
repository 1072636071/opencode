export const dict = {
  ...
  "command.session.export.description": "Sessiya transkriptini tam JSON kimi ixrac et",
  ...
  "prompt.slash.hiddenSkillsHint": "{{count}} bacarıq əmri gizlədilib",
  ...
  "toast.session.export.failed.title": "Sessiyanın ixracı alınmadı",
  ...
  "session.review.collapse": "Yığışdır",
  "session.review.collapse.ariaLabel": "Yığışdır icmal paneli",
