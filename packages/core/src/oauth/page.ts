...
// 唐风印章「信」字标（ADR-014）：烫金圆印章 + 楷书「信」字 + 云纹点饰。
const WORDMARK = `<svg class="wordmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234 42" fill="none" aria-label="信使链接" role="img">
        <g transform="translate(24 9)">
          <circle cx="12" cy="12" r="11" fill="none" stroke="var(--oc-icon-strong)" stroke-width="1.4" />
          <circle cx="12" cy="12" r="9.4" fill="none" stroke="var(--oc-icon-weak)" stroke-width="0.6" />
          <g stroke="var(--oc-icon-strong)" stroke-width="0.7" fill="none" stroke-linecap="round">
            <path d="M12 2.6 v-0.9" /><path d="M12 21.4 v0.9" /><path d="M2.6 12 h-0.9" /><path d="M21.4 12 h0.9" />
          </g>
        ...
        <text x="88" y="31" font-family="'TangKai','Kaiti SC','STKaiti','KaiTi',serif" font-size="30" letter-spacing="3" fill="var(--oc-icon-strong)">信使链接</text>
      </svg>`
